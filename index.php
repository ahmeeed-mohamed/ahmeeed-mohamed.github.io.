...
<head>
    <meta charset="utf-8">
    <meta name="description" content="Online Clinic website for booking new appointments and keeping track of patient medical records">
    <meta name="keywords" content="Clinic, hospital, VITA Clinic">
...
<body>
    ...
    <div class="slogan">
            <div class="two">
            <a href="indix.php"><img src="logo.png" class="logo"></a>
            <ul id="one">
                <li><a href="Happointment.php">New Appointment</a></li>
                <li><a href="HContact.php">Contact</a></li>
                <li><a href="Habout.php">AboutUs</a></li>
                <li><a href="signin.php">LogIn</a></li>
                <li><a href="signup.php">SignUp</a></li>
                <li><a href="ar_Home.php">عربي</a></li>
            </ul>
        </div>
...
<!-------------------------------------------------------------------------------------->
    ...
    <div class="Middle">
        <h1>WHY CHOOSE VITA CLINIC?</h1>
        <div class="one">
             <i class="fas fa-ambulance" id="font" style="font-size: 50px"></i>
            <h2>More Experience</h2>
            <p>
                Every year, more than a million<br>
               people come to VITA Clinic for care.<br>
               Our highly specialized experts are<br> 
               deeply experienced in treating rare<br>
               and complex conditions.  
            </p>
        </div>

        <div class="one">
            <i class="fas fa-user-md" id="font" style="font-size: 50px"></i>
            <h2>The right answers</h2>
            <p>
                Getting effective treatment depends<br>
                on identifying the right problem.<br> 
                in a recent study, 88% of patients who<br>
                came to VITA clinic for a second opinion<br>
                recieved a new or refined diagnosis.
            </p>
        </div>

        <div class="two">
            <i class="fas fa-medkit" id="font" style="font-size: 50px"></i>
            <h2>Seamless care</h2>
            <p>
                At VITA clinic, every aspect of your<br>
                care is coordinated and teams of<br>
                experts work together to provide<br>
                exactly the care you need. what<br>
                might take months elsewhere can<br>
                often be done in days here<br>

            </p>
        </div>

        <div class="two">
            <i class="fas fa-hospital" id="font" style="font-size: 50px"></i>
            <h2>Unparalleled expertise</h2>
            <p>
                VITA Clinic experts are some of the<br>
                best in the world. in the U.S. news &<br>
                World Reposrt ranking of top<br>
                hospitals, VITA Clinic is consistently<br>
